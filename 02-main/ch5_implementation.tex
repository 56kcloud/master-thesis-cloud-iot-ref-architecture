...
\begin{center}
    \begingroup
    \includegraphics[width=1\columnwidth]{implementation/sequence_diagram_certificate_rotation_app.pdf}
...
\begin{center}
    \begingroup
    \includegraphics[width=1\columnwidth]{implementation/sequence_diagram_led_app.pdf}
