...
This application does not run in a Docker container, but directly in the Greengrass component. The operation of the application must be kept simple. A state diagram in figure \ref{fig:state_diagram_OS_update} shows this.
\begin{center}
    \begingroup
    \includegraphics[width=.25\columnwidth]{design/state_diagram_OS_update.pdf}
    \captionof{figure}{\acrshort{os} update application state diagram}
    \label{fig:state_diagram_OS_update}
    \endgroup
\end{center}
...
This application runs in a Docker container. A state diagram illustrates its behaviour in figure \ref{fig:state_diagram_certificate_rotator}.
\begin{center}
    \begingroup
    \includegraphics[width=.6\columnwidth]{design/state_diagram_certificate_rotator.pdf}
    \captionof{figure}{Certificate rotator application state diagram}
    \label{fig:state_diagram_certificate_rotator}
    \endgroup
\end{center}
