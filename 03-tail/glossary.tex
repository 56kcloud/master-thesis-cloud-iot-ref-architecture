...
\newglossaryentry{provisioning}{
    name=provisioning,
    description={In this project, provisioning means the automated linking of an embedded system with a cloud infrastructure. This includes the creation of a digital twin of the device, enabling the device to communicate with cloud services.}
}
